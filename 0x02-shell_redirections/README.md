Contains Questions to uploaded answers:
...
6-Write a script that displays the third line of the file iacta.The file iacta will be in the working directory (NB!!You’re not allowed to use sed
...
13- Create a script that takes a lCreate a script that removes all letters c and C from input.ist of words as input and prints only words that appear exactly once.
